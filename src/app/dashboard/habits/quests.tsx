...
export default function HabitQuestsPage() {
  return (
    <div className="max-w-2xl mx-auto py-8 px-4">
      ...
      <div className="flex gap-6 border-b border-gray-200 mb-8">
        ...
        <a href="/dashboard/habits/quests" className="py-2 px-1 font-medium text-blue-700 border-b-2 border-blue-600">Quests</a>
      </div>
      <h1 className="text-3xl font-bold mb-6">Quests & Story Mode</h1>
      <div className="bg-white rounded shadow p-6">
        <p className="text-gray-600">(Quests, challenges, and story progress for your habits will go here.)</p>
      </div>
    </div>
  );
} 